...
/**
 * Loads the algorithms exercises onto the Java practice track. A Java migration for the same
 * reason as {@link V13__LoadJavaPractice}, which this follows line for line: the content is
 * source code, and Flyway would try to interpret parts of it if it went through a plain script.
 *
 ...
 */
public class V34__LoadAlgorithmsPractice extends BaseJavaMigration {

    private static final String CONTENT = "/content/practice/algorithms.json";
