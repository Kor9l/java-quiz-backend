...
/**
 * Adds Git as a study topic: eight sections, their articles and 48 quiz questions.
 *
 * <p>Self-contained in the way {@link V6__LoadSqlTopic} established and
 * {@link V8__LoadJavaConcurrencyTopic} repeated — content under {@code /content/git/} rather than
 * in the shared files V2 reads, because V2 has already run everywhere and editing its sources
 ...
 * {@code MIDDLE}, so a missing level would load silently as middle; {@code GitTopicContentTest}
 * is what holds the content to an explicit value on every row, and {@link #level(JsonNode)} here
 * is the second line of defence.
 */
public class V35__LoadGitTopic extends BaseJavaMigration {
