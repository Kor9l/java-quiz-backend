...
/**
 * Adds HTTP and REST API design as a study topic: eight sections, their articles and 48 quiz
 * questions.
 *
 * <p>Follows the self-contained layout {@link V6__LoadSqlTopic} established — content under
 * {@code /content/rest-http/} rather than in the shared files V2 reads, because V2 has
 ...
 *
 * <p>Sections and questions carry the career {@code level} added by {@code V7__levels}. The
 * column defaults to {@code MIDDLE}, so a missing level would load silently as middle;
 * {@code RestHttpTopicContentTest} is what holds the content to an explicit value on every row.
 */
public class V23__LoadRestHttpTopic extends BaseJavaMigration {
